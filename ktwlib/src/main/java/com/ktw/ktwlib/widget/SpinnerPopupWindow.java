...
import com.ktw.ktwlib.adapter.SpinnerPopAdapter;
...
public class SpinnerPopupWindow extends PopupWindow {
    ...
    public SpinnerPopupWindow(Activity context, final String item, final List<String> itemList, int width, int height, AdapterView.OnItemClickListener itemClickListener) {
